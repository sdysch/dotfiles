# Generated by Powerlevel10k configuration wizard on 2020-12-09 at 22:40 GMT.
...
# lightest, 24h time, round separators, round heads, round tails, 2 lines, dotted,
# no frame, sparse, many icons, concise, transient_prompt, instant_prompt=auto-off.
