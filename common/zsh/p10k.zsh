# Generated by Powerlevel10k configuration wizard on 2020-04-14 at 18:03 BST.
...
# blurred heads, flat tails, 2 lines, disconnected, left frame, sparse, fluent,
...
() {
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=76
