...
NORD_TMUX_COLOR_THEME_FILE=theme/nord.conf
NORD_TMUX_VERSION=0.3.0
NORD_TMUX_STATUS_CONTENT_FILE="theme/nord-status-content.conf"
NORD_TMUX_STATUS_CONTENT_NO_PATCHED_FONT_FILE="theme/nord-status-content-no-patched-font.conf"
