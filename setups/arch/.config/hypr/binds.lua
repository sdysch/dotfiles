...
hl.bind(mainMod .. " + " .. "equal", hl.dsp.exec_cmd("pactl set-sink-volume 0 +5%"))
hl.bind(mainMod .. " + " .. "minus", hl.dsp.exec_cmd("pactl set-sink-volume 0 -5%"))
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("pactl set-sink-mute 0 toggle"), { locked = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("pactl set-source-mute @DEFAULT_SOURCE@ toggle"), { locked = true })
hl.bind(mainMod .. " + " .. "M", hl.dsp.exec_cmd("pactl set-sink-mute 0 toggle"))
